podTemplate(
        ...
        containers: [
                ...
                containerTemplate(name: 'nginx-php-fpm', image: 'kuzaxak/php-fpm-nginx:1.0.0'),
        ...
        envVars: [
            envVar(key: 'INSLY_CONFIG', value: 'config_docker.ini'),
        ]
) {
    node('insly_test_podv2') {
        timestamps {
            stage("checkout") {
